    ...
    <section>
      ...
      <div className="item">
        ...
        <p>
          ...
          renew under the exact same conditions unless you cancel it or OvGames
          cancels it. You may cancel your Subscription renewal either through
          your online account management page or by contacting the OvGames
          customer support team.
        </p>
        <p>
          A valid payment method, including credit card or PayPal, is required
          to process the payment for your Subscription. You shall provide our
          third party payment service provider with accurate and complete
          billing information including full name, address, state, zip code,
          telephone number, and a valid payment method information. By
          submitting such payment information, you automatically authorize our
          third party payment service provider to charge all Subscription fees
          incurred through your account to any such payment instruments.
        </p>

        <h3>Free Trial</h3>
        <p>
          OvGames may, at its sole discretion, offer a Subscription with a free
        ...
        <p>
          ...
          Trial, you will not be charged by OvGames until the Free Trial has
        ...
        <p>
          At any time and without notice, OvGames reserves the right to (i)
        ...
        <h3>Fee Changes</h3>
        <p>
          OvGames, in its sole discretion and at any time, may modify the
        ...
        <p>
          OvGames will provide you with a reasonable prior notice of any change
        ...
        <h3>Refunds</h3>
        <p>
          Certain refund requests for Subscriptions may be considered by OvGames
          on a case-by-case basis and granted in sole discretion of OvGames.
        </p>
        ...
        <p>
          OvGames has the right but not the obligation to monitor and edit all
          Content provided by users.
        </p>
        <p>
          In addition, Content found on or through this Service are the property
          of OvGames or used with permission. You may not distribute, modify,
        ...
        <p>
          ...
          with our <a href="mailto:ovgamesdev@gmail.com">contact form</a>, and
        ...
        <p>
          ...
          <a href="mailto:ovgamesdev@gmail.com">contact form</a>.
        </p>
        ...
        <p>
          ...
          that are not owned or controlled by OvGames
        </p>
        <p>
          OvGames has no control over, and assumes no responsibility for the
        ...
        <p>
          You acknowledge and agree that OvGames shall not be responsible or
        ...
        <p>
          ...
          <a href="mailto:ovgamesdev@gmail.com">contact us</a> to request an
          account deletion.
        </p>
        <p>
        ...
        <p>
          You agree to defend, indemnify and hold harmless OvGames and its
        ...
        <p>
          In no event shall OvGames, nor its directors, employees, partners,
        ...
        <p>
          OvGames its subsidiaries, affiliates, and its licensors do not warrant
        ...
        <p>
          ...
          <a href="mailto:ovgamesdev@gmail.com">contact us</a>.
        </p>
      </div>
    </section>
  );
