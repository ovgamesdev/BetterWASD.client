  ...
  return (
    <section>
      ...
      <div className="item">
        ...
        <p>
          OvGames ("us", "we", or "our") operates the betterwasya.vercel.app website and ovgamesdev.github.io website and the BetterWASYA
          browser extension (hereinafter referred to as the "Service").
        </p>
        <p>
        ...
        <ul>
          <li>
            <p>
              ...
              <br />
              <br />
              Service means the betterwasya.vercel.app website and ovgamesdev.github.io website and the BetterWASYA browser extension
              operated by OvGames
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              ...
              <br />
              <br />
              Data Controller means the natural or legal person who (either alone or jointly or in common with other persons) determines the
              purposes for which and the manner in which any personal information are, or are to be, processed.
              <br />
              <br />
        ...
        <p>
          If you are from the European Economic Area (EEA), OvGames legal basis for collecting and using the personal information described
          in this Privacy Policy depends on the Personal Data we collect and the specific context in which we collect it.
        </p>
        ...
        <p>
          OvGames will retain your Personal Data only for as long as is necessary for the purposes set out in this Privacy Policy. We will
        ...
        <p>
          OvGames will also retain Usage Data for internal analysis purposes. Usage Data is generally retained for a shorter period of time,
        ...
        <p>
          OvGames will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this
        ...
        <p>
          If OvGames is involved in a merger, acquisition or asset sale, your Personal Data may be transferred. We will provide notice
          before your Personal Data is transferred and becomes subject to a different Privacy Policy.
        </p>
        <h3>Disclosure for Law Enforcement</h3>
        <p>
          Under certain circumstances, OvGames may be required to disclose your Personal Data if required to do so by law or in response to
        ...
        <p>
          If you are a resident of the European Economic Area (EEA), you have certain data protection rights. OvGames aims to take
        ...
        <ul>
          ...
          <li>
            <p>
              The right to withdraw consent. You also have the right to withdraw your consent at any time where NightDev, LLC relied on your
        ...
        <p>
          ...
          whose use of your personal information is governed by their Privacy Policy. These payment processors adhere to the standards set
          by PCI-DSS as managed by the PCI Security Standards Council, which is a joint effort of brands like Visa, MasterCard, American
        ...
        <p>
          ...
          and you are aware that your Child has provided us with Personal Data, please <a href="mailto:ovgamesdev@gmail.com">contact us</a>.
          If we become aware that we have collected Personal Data from children without verification of parental consent, we take steps to
