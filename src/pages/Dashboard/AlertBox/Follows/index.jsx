...
const Follows = ({ settings, setSettings }) => {
  return (
    <>
      <div className="row">
        <div className="left">
        ...
        <div className="right">
          <CheckBox checked={settings.follow_enabled} onChange={(e) => setSettings({ ...settings, follow_enabled: e.target.checked })} />
        </div>
      </div>
      <div className="row">
        <div className="left">
      ...
      <div className="row">
        ...
        <div className="right">
          <div className="split">
            <Select defaultValue={{ value: settings.follow_show_animation }} onChange={(value) => setSettings({ ...settings, follow_show_animation: value.value })} options={animationAlertShow} />
            <Select defaultValue={{ value: settings.follow_hide_animation }} onChange={(value) => setSettings({ ...settings, follow_hide_animation: value.value })} options={animationAlertHide} />
          </div>
        </div>
      </div>
      <div className="row">
      ...
      <div className="row">
        ...
        <div className="right">
          <div className="split">
            <Select defaultValue={{ value: settings.follow_text_animation }} onChange={(value) => setSettings({ ...settings, follow_text_animation: value.value })} options={animationText} />
      ...
      <Accordion title_open="Открыть настройки шрифта" title_close="Закрыть настройки шрифта">
        <div className="row">
          ...
          <div className="right">
            <CreatableSelect defaultValue={{ value: settings.follow_font }} onChange={(value) => setSettings({ ...settings, follow_font: value.value })} options={fontOptions} />
          </div>
        </div>
        <div className="row">
          <div className="left">
        ...
        <div className="row">
          ...
          <div className="right">
            <ColorPicker value={settings.follow_font_color} onChange={(color) => setSettings({ ...settings, follow_font_color: color })} />
          </div>
        </div>
        <div className="row">
          <div className="left">
          ...
          <div className="right">
            <ColorPicker value={settings.follow_font_color2} onChange={(color) => setSettings({ ...settings, follow_font_color2: color })} />
          </div>
        </div>
      </Accordion>
    </>
